...
<!-- <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-black  bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
    @if (Route::has('login'))
    ...
    @endif
    <div class="realtive sm:flex sm:justify-center bg-pink-100 text-yellow-600">
        <button class="bg-orange p-2 rounded text-yellow-600">Cick me</button>
    </div>
</div> -->